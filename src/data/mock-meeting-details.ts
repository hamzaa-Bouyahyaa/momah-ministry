...
export const MOCK_DETAILED_MEETINGS: DetailedMeeting[] = [
  ...
  },
  {
    ...
    duration: "xx دقيقة",
    attendees: [
      { id: "a3", name: "فهد العتيبي", avatar: "https://i.pravatar.cc/40?img=3" },
      { id: "a4", name: "سارة الشمري", avatar: "https://i.pravatar.cc/40?img=4" },
      { id: "a5", name: "نورة الحربي", avatar: "https://i.pravatar.cc/40?img=5" },
    ],
    agenda: AGENDA_ITEMS,
    support: SUPPORT_ITEMS,
  },
  ...
  },
  {
    ...
    duration: "xx دقيقة",
    attendees: [
      { id: "a9", name: "أحمد المالكي", avatar: "https://i.pravatar.cc/40?img=9" },
      { id: "a10", name: "سلطان العنزي", avatar: "https://i.pravatar.cc/40?img=10" },
    ],
    agenda: AGENDA_ITEMS,
    support: SUPPORT_ITEMS,
  },
